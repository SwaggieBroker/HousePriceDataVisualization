...
urlpatterns = [
    ...
    url(r'^api/v1/houseinfo/', include('houseinfo.urls', namespace='houseinfo')),
    url(r'^api/v1/sellinfo/', include('sellinfo.urls', namespace='sellinfo')),
    url(r'^api/v1/community/', include('community.urls', namespace='community')),
